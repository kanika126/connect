  ...
  return (
    <div className="bg-white min-h-screen flex items-center justify-center mb-30">
      <div className="text-indigo-500 text-center">
        ...
        <a href="/signin" className="bg-indigo-500 text-white py-3 px-5 rounded-full text-lg transition duration-300 hover:bg-indigo-300 hover:text-white">Sign In</a>
      </div>
    </div>
  );
}
